...
import PredioCertificacion from "../../modules/predio/components/predio-certificacion";
...
const PlaceProfile = () => {
  ...
  const { data, isLoading, isFetching } = usePlaceQuery({
    id,
    spanishType: type,
  });
    ...
    <CenteredContainer className="PlaceProfile__container">
      <div className="PlaceProfile__header">
        ...
        <h2 className="PlaceProfile__subtitle">
          {data.displayType} en{" "}
          <span className="PlaceProfile__location">
            {data.nameDepartamento}
          </span>
        </h2>
        <h2 className="PlaceProfile__subtitle">
          RUC: {data.ruc} • Padrón: {data.padron}
        </h2>
      </div>
      <div className="PlaceProfile__body">
        <div className="PlaceProfile__place_data">
          <div className="PlaceProfile__extra_data">
            <h3 className="PlaceProfile__section_title">
        ...
        {["slaughterhouse"].includes(data.type) && (
          <div className="PlaceProfile__links">
            <h3 className="PlaceProfile__section_title">
              Relaciones con otros establecimientos
            </h3>
            <PlaceCSTI />
          </div>
        )}
