...
import PredioEcasInfos from "../../modules/predio/components/predio-ecas-infos";
...
const FarmProfile = () => {
  ...
  const { data: animalsData, isLoading: loadingAnimals } = useFarmAnimalsQuery({
    id,
  });
  ...
  return (
    <CenteredContainer className="FarmProfile__container">
      <div className="FarmProfile__header">
        ...
        <h2 className="FarmProfile__subtitle">
          {data.displayType} en{" "}
          <span className="FarmProfile__location">
            {data.nameDepartamento}, {data.nameProvincia}, {data.nameDistrito}
          </span>
        </h2>
      ...
      <div className="FarmProfile__body">
        <div className="FarmProfile__place_data">
          <div className="FarmProfile__extra_data">
            <h3 className="FarmProfile__section_title">
        ...
        <div className="FarmProfile__Item">
          <PredioEcasInfos document={data?.extraData?.DNI?.trim()} />
        </div>
